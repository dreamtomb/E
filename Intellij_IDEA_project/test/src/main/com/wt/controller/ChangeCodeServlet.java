        ...
        try {
            ...
            if (oldpa.equals(user.getCode())) {
                if (newpa.equals(confpa)) {
                    ...
                    out.println("  <BODY bgcolor=#8dd8f8>");
                    out.print("  <img src=image/f.png ><font size=6 color=red>新旧密码不一致</font> ");
                    out.println("  </BODY>");
                }
            } else {
                out.println("  <BODY bgcolor=#8dd8f8>");
                out.print("  <img src=image/f.png ><font size=6 color=red>密码错误</font> ");
                out.println("  </BODY>");
            }
        } catch (Exception e) {
            out.println("<img src=image/f.png >修改失败");
        }
        out.flush();
        out.close();
    }
