    ...
    <SCRIPT Language="javascript" type="text/javascript">
        function isValid() {
            if (formaddstu.sid.value == "") {
                window.alert("学号不能为空！");
                formaddstu.sid.focus();
                return false;
            }
            if (formaddstu.sname.value == "") {
                window.alert("姓名不能为空！");
                formaddstu.sname.focus();
                return false;
            }

            if (formaddstu.sclass.value == "") {
                window.alert("班级不能为空！");
                formaddstu.sclass.focus();
                return false;
            }
            if (formaddstu.scode.value == "") {
                window.alert("密码不能为空！");
                formaddstu.scode.focus();
                return false;
            }
            formaddstu.submit();
        }
...
<body bgcolor="#8dd8f8">
<form name="formaddstu" action="/../StudentServlet" method="post" onsubmit="return isValid(this);">
    <div align="center">
