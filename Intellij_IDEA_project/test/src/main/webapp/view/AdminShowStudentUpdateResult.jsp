...
<form name="formupdate" action="/../StudentServlet" method="post" onsubmit="return isValid(this);">

    <table width="650" border="1" cellspacing="0" cellpadding="0" align="center">
        <tr>
            <th height="25" colspan="2"><input type="hidden" name="action" value="update"/><font
                    size="4">请在下表输入修改后学生信息</font></th>
        </tr>
        <%
            for (int j = 0; j < i; j++) {
