...
<table border="1" align="center" cellspacing="0" cellpadding="0">
    ...
    <tr align="center">
        ...
        <td><%=Math.round(stu.getAcredit() * 100) / 100.0 %>
        </td>
        <td><%=Math.round(stu.getEgrade() * 100) / 100.0 %>
        </td>
        <td><%=stu.getClasspm() %>
        </td>
        <td><%=stu.getMajorpm() %>
