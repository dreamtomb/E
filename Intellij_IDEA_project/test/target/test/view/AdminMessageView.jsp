...
<jsp:useBean id="msgdao" class="wt.dao.MassageDAO" scope="page"/>
<body bgcolor="#8dd8f8">
<%
...
<table border="1" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr align="center" height="25">
        ...
        <td align="left"><%=rcontent %>
        </td>
        <td height="10" width="50" background="../image/delete.gif " align="center"><strong><a
                href="../view/AdminDealingMessageResult.jsp?mid=<%=mid%>&action=delete">删除</a></strong></td>
    </tr>
    <%} else { %>
    <tr align="center" height="25">
        <td><%=rid %>
        ...
        <td height="10" width="50" background="../image/delete.gif " align="center"><strong><a
                href="../view/AdminDealingMessageMain.jsp?rid=<%=rid %>">回复</a></strong></td>
        <td height="10" width="50" background="../image/delete.gif " align="center"><strong><a
                href="../view/AdminDealingMessageResult.jsp?mid=<%=mid%>&action=delete">删除</a></strong></td>
    </tr>
    <%
