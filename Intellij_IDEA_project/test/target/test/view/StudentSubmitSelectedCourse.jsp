    ...
    <SCRIPT Language="javascript" type="text/javascript">
        function isValid() {
            if (formdelcou.cno.value == "") {
                ...
                formdelcou.cno.focus();
                return false;
            }
            if (formdelcou.cteachno.value == "") {
                window.alert("教学班号不能为空！");
                formdelcou.cteachno.focus();
                return false;
            }
            if(isNaN(formdelcou.cteachno.value)){
                window.alert("课程班号只能为数字！");
                formdelcou.cteachno.focus();
                return false;
            }
            formdelcou.submit();
...
<form name="formdelcou" action="/../StuCourServlet" method="post"
