...
<head>
    <base href="<%=basePath%>">
    <jsp:useBean id="scdao" scope="page" class="wt.dao.StuCourDAO"/>
    <jsp:useBean id="cdao" scope="page" class="wt.dao.CourseDAO"/>
    <title></title>
    <%
...
%>
<div align="center"><font size="4" color="#000080" face="华文楷体"><b><font size="5"><%=cou.getCname() %>选课学生如下：</font></b></font>
</div>
<form name="scoresub" action="/../StuCourServlet?sn=<%=i %>&tid=<%=tid %>&cno=<%=cno %>" method="post">
    <table border="1" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
            ...
            <th colspan="3"><input type="submit" name="submit" value="暂时提交"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="submit" name="submit" value="最终提交"/><input type="hidden" name="action" value="scoresub"/>
            </th>
        </tr>
        <tr>
            <td colspan="8">
