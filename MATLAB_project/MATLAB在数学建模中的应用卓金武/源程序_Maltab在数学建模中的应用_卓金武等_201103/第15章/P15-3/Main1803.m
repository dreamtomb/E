...
TestDataOut=[];
%从D盘读入学习、测试和预测的样本数据
TrainTest=load('F:\MATLAB_project\matlab在数学建模中的应用\源程序_Maltab在数学建模中的应用_卓金武等_201103\第15章\P15-3\water.txt');
TrainTest=TrainTest';
PredictDataIn=load('F:\MATLAB_project\matlab在数学建模中的应用\源程序_Maltab在数学建模中的应用_卓金武等_201103\第15章\P15-3\third.txt');
