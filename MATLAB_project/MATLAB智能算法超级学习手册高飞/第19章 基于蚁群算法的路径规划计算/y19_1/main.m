...
%% 描绘障碍物图形
fill(position(1:4,1),position(1:4,2),[0,1,0]);
fill(position(5:8,1),position(5:8,2),[0,1,0]);
fill(position(9:12,1),position(9:12,2),[0,1,0]);
fill(position(13:15,1),position(13:15,2),[0,1,0]);
